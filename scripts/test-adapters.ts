...
const excelRoundtrip = excelToJson("/tmp/test-roundtrip.xlsx");
...
// Test that we get the expected types for our test data
...
// Test applying overrides: change age from number to text
...
// After override, age should be a string
